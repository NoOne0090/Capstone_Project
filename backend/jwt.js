...
app.post('/register', async (req, res) => {
    ...
    if(existingUser){
        ...
        createModel.create({ firstName, lastName, email, password })
        .then(data => res.json({
...
app.post('/login', (req, res) => {
    ...
    jwtModel.create({ username, email, password })
    .then(data => {
...
app.delete('/deleteAccount', verifyToken, async (req, res) => {
    ...
    await createModel.findOneAndDelete({ email });
